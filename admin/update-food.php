...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        // get the value based query executed
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    $image_name = $_FILES['image']['name']; //new image names
                    ...
                    if($image_name!="")
                    {
                        ...
                        // get the source and the destination path
                    ...
                    {
                        $image_name = $current_image; //Default image wheen image is not selected
                    }
                }
                else
                {
                    $image_name = $current_image; //Default image wheen Button is not clicked
                }
